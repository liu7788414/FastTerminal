...
{
    [Export]
    public class StockQuotPanelViewModel : ViewModelBase<StockQuotPanel>
    {
        ...
        public StockQuotPanelViewModel(
            StockQuotPanel view,
            ...
            : base(view)
        {
            ...
            ((StockQuotPanelViewModelProxy)View.Resources["ViewModelProxy"]).ViewModel = this;
        }
    ...
    public class StockQuotPanelViewModelProxy
    {
        public StockQuotPanelViewModel ViewModel { get; set; }
    }
}
