...
namespace TradeStation.Future.ViewModels
{
    ...
    public class OptionRealTimePriceViewModel : RealTimePriceViewModelBase
    {
        #region Properties
        ...
        public OptionRealTimePriceViewModel(
        ...
        protected override void RefreshHoldingPosition()
        {
            ...
            {
                var currentPositions = _tradeInfo.PositionInfoCollection.OptionPositionInfoList.Where(x =>
        ...
        protected override void OnFastBuyCommand(double? price)
        {
            ...
            if (null != price && 0 != price.Value)
            {
                ...
                Tuple<eMarketType, string, double, string, int, eFuturesDirection> inputParameter = null;
                ...
                if (this.HoldingShortPosition.EnableAmount > 0)
                {
                    ...
                    inputParameter = new Tuple<eMarketType, string, double, string, int, eFuturesDirection>(
                ...
                _eventAggregator.GetEvent<FastBuyOptionEvent>().Publish(inputParameter);
            }
        }
        ...
        protected override void OnFastSellCommand(double? price)
        {
            ...
            if (null != price && 0 != price.Value)
            {
                ...
                _eventAggregator.GetEvent<FastSellOptionEvent>().Publish(inputParameter);
            }
        }
    }
}
