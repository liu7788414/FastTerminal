...
namespace TradeStation.Modules.Trade.Views
{
    ...
    /// </summary>
    [ViewExport(RegionName = RegionNames.OptionEntrustRegion)]
    public partial class EntrustPanelOption
    {
        public EntrustPanelOption()
        {
            InitializeComponent();
            Filter();
        }
        ...
        [Import]
        public EntrustPanelViewModelOption Model
        {
            get
            {
                return DataContext as EntrustPanelViewModelOption;
            }
            set
            {
                DataContext = value;
