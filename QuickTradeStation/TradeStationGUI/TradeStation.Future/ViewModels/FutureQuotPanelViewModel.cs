...
{
    [Export]
    public class FutureQuotPanelViewModel : ViewModelBase<FutureQuotPanel>
    {
        ...
        public FutureQuotPanelViewModel(
            FutureQuotPanel view,
            ...
            : base(view)
        {
            ...
            ((FutureQuotPanelViewModelProxy)View.Resources["ViewModelProxy"]).ViewModel = this;
        }
    ...
    public class FutureQuotPanelViewModelProxy
    {
        public FutureQuotPanelViewModel ViewModel { get; set; }
    }
}
